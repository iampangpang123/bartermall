...
var bar1 = new Q6MenuBar("bar1", "易货后台管理");
function load() {
	bar1.colorStyle = 2;
	bar1.config.imgDir = "<c:url value='/imgs/'/>";
	bar1.config.radioButton=false;
	bar1.add("分类管理", "查看分类", "<c:url value='/admin/findAll.action'/>", "body");
	bar1.add("分类管理", "添加分类", "<c:url value='/adminjsps/admin/category/add.jsp'/>", "body");

	bar1.add("商品管理", "查看商品", "<c:url value='/adminFindListProducts.action'/>", "body");
	bar1.add("商品管理", "下架商品", "<c:url value='/adminFindListProducts.action'/>", "body");
	...
	bar1.add("公告管理", "添加公告", "<c:url value='/adminjsps/admin/content/list.jsp'/>", "body");
	bar1.add("公告管理", "查看公告", "<c:url value='/adminjsps/admin/content/list.jsp'/>", "body");
	
	bar1.add("用户管理", "查看用户", "<c:url value='/adminFindListUser.action'/>", "body");
