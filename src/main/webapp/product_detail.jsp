...
<link media="all" href="css/product_detail.css" type="text/css"
	rel="stylesheet">
...
$("#buy-button").click(function(){
	...
	/* 	 urlValPid = getUrlParam('pid'); */
		 window.location.href="addCart.action?pid="+urlValPid;
...
<body>
	<iframe style="position: fixed; display: none; opacity: 0;"
		src="index_1.html" frameborder="0"></iframe>
			...
			<div class="ershou-details">
				...
				<div class="ershou-info">
					...
					<ul class="ershou-detail">
						<li class="ershou-place" id="pid"></li>
					</ul>
					<!-- <div id="buy-button" >
